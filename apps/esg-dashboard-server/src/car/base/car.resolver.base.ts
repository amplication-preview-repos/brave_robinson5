...
export class CarResolverBase {
  ...
  async createCar(@graphql.Args() args: CreateCarArgs): Promise<Car> {
    return await this.service.createCar({
      ...
      data: {
        ...
        reading: args.data.reading
          ? {
              connect: args.data.reading,
            }
          : undefined,
  ...
  async getReading(@graphql.Parent() parent: Car): Promise<Reading | null> {
    const result = await this.service.getReading(parent.id);
