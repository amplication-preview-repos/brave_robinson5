...
@InputType()
class ReadingCreateNestedManyWithoutIoTDevicesInput {
...
export { ReadingCreateNestedManyWithoutIoTDevicesInput as ReadingCreateNestedManyWithoutIoTDevicesInput };
