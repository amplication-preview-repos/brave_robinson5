...
@InputType()
class ReadingCreateNestedManyWithoutEsgMetricsInput {
...
export { ReadingCreateNestedManyWithoutEsgMetricsInput as ReadingCreateNestedManyWithoutEsgMetricsInput };
